  ...
  return (
    <div className="min-h-screen bg-white pt-24">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Tabs */}
        <div className="flex gap-4 md:gap-8 mb-12 border-b border-gray-100 overflow-x-auto scrollbar-none">
          {["details", "password", "orders", "settings"].map((tab) => (
            <button
              ...
              className={`text-xs md:tracking-[0.2em] tracking-[0.1em] uppercase pb-4 transition-colors whitespace-nowrap ${
                activeTab === tab
